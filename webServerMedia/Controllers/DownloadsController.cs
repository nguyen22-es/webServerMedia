...
namespace webServerMedia.Controllers
{
    ...
    public class DownloadsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<DownloadDTO>> Post(int moduleId, DownloadDTO model)
        {
            try
            {
                ...
                if (model.Title is null) return BadRequest("Title is required");
        ...
        public async Task<ActionResult<DownloadDTO>> Put(int id, int courseId, int moduleId, DownloadDTO model)
        {
            try
            {
                ...
                var exists = await _db.AnyAsync<Topic>(a => a.Id.Equals(courseId));
